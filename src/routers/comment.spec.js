...
describe('GET /comments/realId', () => {
  it('should return array of comments', done => {
    request(app)
      .get('/comments/5f75c6cdef0873137397d850')
      .expect(res => {
...
describe('POST /comment', () => {
  it('should return created comment with 201 status, authorization required', done => {
    request(app)
      .post('/comment')
      .set('Authorization', 'Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJfaWQiOiI1Zjc1OTlhOGFjYzZiNTE4ZTZjNzNmZjgiLCJpYXQiOjE2MDE1NDI1OTd9.VlfrO1PhSqQ31-wZTK5xtchGcjVRFZmgCJZHZgHc5Rk')
      .send({ content: 'test', postId: '5f75c8163a2e0313aaa685c3' })
      .expect(res => {
...
describe('POST /comment', () => {
  it('should return error with 400 status, authorization required', done => {
    request(app)
      .post('/comment')
      .set('Authorization', 'Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJfaWQiOiI1Zjc1OTlhOGFjYzZiNTE4ZTZjNzNmZjgiLCJpYXQiOjE2MDE1NDI1OTd9.VlfrO1PhSqQ31-wZTK5xtchGcjVRFZmgCJZHZgHc5Rk')
      .send({ postId: '5f75c8163a2e0313aaa685c3' })
      .expect(400, done);
  });
});
